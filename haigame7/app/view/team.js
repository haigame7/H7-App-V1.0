  ...
  _renderRecruitRow(rowData){
    ...
    <TouchableOpacity style={styles.teamlist} activeOpacity={0.8} onPress={()=>this.gotoRoute('teaminfo',rowData)}>
      ...
      <View style={styles.teamlistright}>
        ...
        <TouchableOpacity  onPress={()=>this.state.content.userData.UserID==0||this.state.content.userData.userID==undefined?Toast.show('请先登录'):this.applyTeam(this.state.content.userData.UserID,rowData.TeamID)} style = {[this.state.invite==0 ? commonstyle.btnredwhite : commonstyle.btncreamblack, styles.teamlistbtn]} activeOpacity={0.8}>
  ...
  _renderInviteRow(rowData){
    ...
    return(
      <TouchableOpacity style={styles.userlist} activeOpacity={0.8} onPress={()=>this.gotoRoute('playerinfo',rowData)}>
        ...
        <TouchableOpacity onPress={()=>this.state.content.userData.UserID==0||this.state.content.userData.userID==undefined||this.state.userteamid==0?Toast.show('请先创建战队'):this.inviteUser(rowData.UserID,this.state.userteamid)}  style = {[this.state.invite==0 ? commonstyle.btnredwhite : commonstyle.btncreamblack, styles.userlistbtn]} activeOpacity={0.8}>
