...
export default class extends Component{
  ...
  _gotoRecharge(money,argument) {
    ...
    switch (money) {
      case 60:
        productID = 'com.haigame7.ios60hq'
        break;
      case 120:
        productID = 'com.haigame7.ios120hq'
        break;
      case 250:
        productID = 'com.haigame7.ios250hq'
        break;
      case 500:
        productID = 'com.haigame7.ios500hq'
        break;
      case 980:
        productID = 'com.haigame7.ios980hq'
        break;
      case 5180:
        productID = 'com.haigame7.ios5180hq'
        break;
      default:
    ...
    if (Platform.OS == 'android') {
      ...
      PaymentManager.purchaseEvent(productID.toString(), (res)=>{
      //  Alert.alert('d');
      console.log(res);
      });
    }else {
  ...
  render(){
    ...
    if (Platform.OS == 'android') {
      ...
      btn = (
       <TouchableHighlight style={styles.btn} underlayColor={'#FF0000'} onPress={() => this._gotoRecharge(this.state.data.money)}>
         <Text style={styles.btnfont} >{'确认充值'}</Text>
       </TouchableHighlight>
      )
      inputView = (
      ...
      <View >
        ...
        <View style={commonstyle.bodyer}>
          ...
          <View style={[commonstyle.row, styles.rechargeview]}>
            <TouchableHighlight onPress={() => this._selectRecharge(60)} style={[this.state.data.money==60?commonstyle.btnborderred:commonstyle.btnbordergray, commonstyle.col1, styles.recharge]} >
              <Text style={this.state.data.money==60?commonstyle.red:commonstyle.gray} >{'60氦气'}</Text>
            </TouchableHighlight>
            <View style={styles.rechargeline}></View>
            <TouchableHighlight onPress={() => this._selectRecharge(120)} style={[this.state.data.money==120?commonstyle.btnborderred:commonstyle.btnbordergray, commonstyle.col1, styles.recharge]}>
              <Text style={this.state.data.money==120?commonstyle.red:commonstyle.gray}>{'120氦气'}</Text>
            </TouchableHighlight>
            <View style={styles.rechargeline}></View>
            <TouchableHighlight onPress={() => this._selectRecharge(250)} style={[this.state.data.money==250?commonstyle.btnborderred:commonstyle.btnbordergray, commonstyle.col1, styles.recharge]} >
              <Text style={this.state.data.money==250?commonstyle.red:commonstyle.gray} >{'250氦气'}</Text>
            </TouchableHighlight>
          </View>
          <View style={[commonstyle.row, styles.rechargeview]}>
            ...
            <View style={styles.rechargeline}></View>
            <TouchableHighlight onPress={() => this._selectRecharge(980)} style={[this.state.data.money==980?commonstyle.btnborderred:commonstyle.btnbordergray, commonstyle.col1, styles.recharge]} >
              <Text style={this.state.data.money==980?commonstyle.red:commonstyle.gray} >{'980氦气'}</Text>
            </TouchableHighlight>
            <View style={styles.rechargeline}></View>
            <TouchableHighlight onPress={() => this._selectRecharge(5180)} style={[this.state.data.money==5000?commonstyle.btnborderred:commonstyle.btnbordergray, commonstyle.col1, styles.recharge]} >
              <Text style={this.state.data.money==5180?commonstyle.red:commonstyle.gray} >{'5180氦气'}</Text>
            </TouchableHighlight>
          </View>
          {btn}
        </View>
